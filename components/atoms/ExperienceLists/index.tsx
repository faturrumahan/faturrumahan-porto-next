...
const ExperienceLists = () => {
  return (
    <>
      <h3 className="font-bold text-lg lg:text-2xl lg:mb-3">Experiences</h3>
      <ol className="relative border-s border-gray-300">
        {experienceItems.toReversed().map((item, index) => (
          <li key={index + item.title} className="ms-4">
            ...
            <p className="mb-1 text-xs lg:text-sm font-normal leading-none text-gray-400">
            ...
            <p className="mb-4 text-xs md:text-sm lg:text-base font-normal text-gray-500">
              {item.description}
            </p>
          </li>
        ))}
